 ...
 */
public class monetdbjdbc {
    public static void main(String[] args) throws Exception {
        // make sure the driver is loaded
        Class.forName("nl.cwi.monetdb.jdbc.MonetDriver");
        Connection con = DriverManager.getConnection("jdbc:monetdb://en4102945l.cidse.dhcp.asu.edu:54321/memrec", "akamzin", "akamzin");
        ...
        rs = st.executeQuery("select * from movies limit 22");
        ...
        st.setMaxRows(0);
        // we only ask 10 rows
        rs = st.executeQuery("select * from movies limit 10;");
