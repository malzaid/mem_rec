...
public class WriteExcel {
	...
	public void write(long[] userId, long[] time, int dataset, int database, int algorithm)
	...
	private void createContent(WritableSheet sheet, long[] userId, long[] time, int dataset, int database,
			int algorithm) throws WriteException, RowsExceededException {
		// Write a few number
